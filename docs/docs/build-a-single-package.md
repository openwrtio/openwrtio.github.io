...
make menuconfig
```
![make menuconfig wifidog](../img/make-menuconfig-wifidog.png)
...
```
![make wifidog ipk](../img/make-wifidog-ipk.png)
...
![wifidog error: AuthServer is not set](../img/wifidog-authserver-not-set.png)
...
![wifidog conf change gatewayid](../img/wifidog-conf-change-gatewayid.png)
![wifidog conf change authserver](../img/wifidog-conf-change-authserver.png)
![wifidog conf change global](../img/wifidog-conf-change-global.png)
...
![wifidog start](../img/wifidog-start.png)
![wifidog portal](../img/wifidog-portal.png)
